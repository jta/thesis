This chapter refines the concepts proposed in \ac{PREFLEX} given the insights provided by the \ac{MAWI} dataset presented in chapters \ref{chapter:malawi} and \ref{chapter:rate}.
