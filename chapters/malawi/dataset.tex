...
The dataset used is composed from the original, unanonymised traffic \acs{MAWI} \cite{mawi} traces, a set of daily packet captures from the \ac{WIDE} backbone network which provides connectivity to universities and research institutes in Japan. 
